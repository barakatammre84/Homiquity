...
- **Cut-line check:** this *is* the loop, extended to the borrowers with the least competition
  ...
  this program, not a competing effort. The roadmap's trunk-health and delivery-spine queue (CTO_ROADMAP.md §0–§2) remains the standing priority; no
...
The roadmap's trunk-health and delivery-spine queue (§0–§2) remains the standing priority; program work claims only the capacity the
sprint doesn't need.
