...
| `B2-2-03` | Multiple Financed Properties for the Same Borrower | 🟡 partial | Financed-property limits exist ONLY as delivery edit shared/fannieMae/loanDeliveryEdits.ts:642 (>6, from a 2020 EarlyCheck workbook) — not as an eligibility rule in the decision path. The Guide is occupancy-conditional: principal residence non-HomeReady no limit, HomeReady 2, second home/investment DU-10. FINDINGS U-23. Table-derived: confirm against the PDF page before coding. |
