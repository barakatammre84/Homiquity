...
| Component tests / `components/ui` primitives | **BUILT** | 103 client test file(s); 34 primitives — *pnpm test:client* |
...
| `arbitraryTypeScale` — arbitrary size/length value (text-[11px], w-[240px]) | ratcheting down | **168** occurrence(s) |
