...
Landing work: branch → PR → `gate` check **watched to green** → squash merge
([CICD.md](../../runbooks/CICD.md) §Shipping; never `gh pr merge --auto`).
Direct pushes to `main` are barred by doctrine (procedural on the Free plan —
