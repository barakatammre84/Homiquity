...
- **The charter.** `knowledge-base/routines/CHARTER.md` — 1,112 lines, 22 H2s. §6 (`:246-274`):
  ...
  (`financial-audit/SKILL.md:24`, `doc-accuracy/SKILL.md:47-51`); CHARTER §13's clock is 24 h
...
(the shortest complete statement of the value system) → `knowledge-base/routines/CHARTER.md` §4,
