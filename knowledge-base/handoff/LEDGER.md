...
| 2026-08-22 | 074899e3 (+ the corpus) | fresh-hire teach-back test: an agent restricted to this directory (answer key forbidden) answered 100 questions, 96 with a confirmed `path:line`, 2 `DOC GAP`, 2 partial; its friction report's five numeric misses, six line offsets, two contradictions and one unnamed file were fixed in the same PR | founder session | the corpus PR |
