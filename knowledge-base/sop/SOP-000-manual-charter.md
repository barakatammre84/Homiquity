...
`scripts/doc-freshness-guard.cjs` covers only its opt-in Freshness lines (this charter's included),
...
| Trigger | Action |
|---|---|
| Anchor file changes | CI flags it (once the §4 guard exists). Re-read within **5 business days**. |
