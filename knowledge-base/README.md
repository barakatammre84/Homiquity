...
- [research/islamic-finance/](research/islamic-finance/) — alternative / Shariah-compliant (Musharaka/Ijara/Murabaha) "Universal Adaptation Layer" as a **broker-triage future moat**: feasibility + compliance-gap map + lender-channel validation (route is the Ijara-CDC/CMG ecosystem, not UIF/Devon/Guidance) + Shariah-governance validation (structure cert = the funder's) (post-launch; below the L1 cut-line; authorizes nothing).
