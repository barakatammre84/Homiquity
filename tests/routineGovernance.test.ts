...
//
// The routine-registry half of this suite is deliberately NOT here — it shells out
// to scripts/routine-registry-guard.cjs, which ships separately. Re-add its
// `describe` block in that PR rather than stubbing it here.
//
// This exists because a rule with no mechanism behind it is a preference. §8 says no session pushes to `main`, merges a PR, arms
