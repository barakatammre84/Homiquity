...
|-----------|------:|--------------------|
| `public/` | 11 | Logged-out: landing, refinance landing page (`/refinance` — calculator + dual CTAs, no global nav), affordability check ("Can I Afford This Home?"), find-an-agent, auth pages |
