...
3. **Contradictory borrower signals.** The buyer dashboard says "Pre-approved ✓" while insights say "0 documents submitted" and "Low engagement may indicate uncertainty." The borrower state machine (`server/services/borrowerStateMachine.ts`) should make these states mutually consistent.
