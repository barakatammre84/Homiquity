-- 0039: lender-side confirmation on rate locks (audit finding F-3)
...
-- this migration genuinely have no lender confirmation; inventing a
-- confirmation number would falsify a commitment record. They resolve to
-- "unconfirmed quote" via shared/rateLockConfirmation.ts, which is what they
-- always were. New locks cannot be created without these fields.
