...
survive you enter `knowledge-base/feature-review/FINDINGS.md`.
...
- **Intended behavior, not a bug**: check `knowledge-base/handbook/app-guide/`, `knowledge-base/L1_VISION_AND_SCOPE.md`, `CTO_ROADMAP.md`,
...
- **Stale-doc mirage**: the finding compares code to a stale knowledge-base doc. Code is the source of
