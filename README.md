...
| [routines/CHARTER.md](knowledge-base/routines/CHARTER.md) | The operating doctrine: the fleet contract — acceptance questions, the §1a development-first directive (2026-08-23: the Selling Guide is the golden handbook; business activity never gates engineering), decision authority, cadence, write territory. The 2026-07-04 launch-suite doctrine it replaced is archived at [archive/PRE_PRODUCTION_OPS_ROUTINES.md](knowledge-base/archive/PRE_PRODUCTION_OPS_ROUTINES.md). |
