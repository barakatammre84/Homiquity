...
// The "Staff Invites" card — table + the header's Create Invite trigger,
// extracted verbatim from AdminUsers.tsx. Takes onCreateInvite rather than
// owning dialog-open state itself, same as AdminRates' table/dialog split:
// the page keeps ownership of which dialog is open.
