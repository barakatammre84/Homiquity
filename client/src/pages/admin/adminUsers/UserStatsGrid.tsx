...
// The summary-stats + detailed-role-breakdown grids, extracted verbatim from
// AdminUsers.tsx. Pure presentation over the already-computed useAdminUserStats
// output — no state, no queries.
