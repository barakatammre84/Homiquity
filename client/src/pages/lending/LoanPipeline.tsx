...
import { SETTLED_CONDITION_STATUSES } from "@shared/statusVocabularies";
import type { LoanCondition, Document, ApplicationProperty, LoanOption, LoanApplication } from "@shared/schema";
