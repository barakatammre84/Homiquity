        ...
        <div className="grid gap-8 sm:grid-cols-2 md:grid-cols-4">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-1 text-sm text-sidebar-foreground/70">
              ...
              <li><Link href="/ai-coach" className="touch-target flex items-center rounded-md px-2 py-2 -mx-2 hover:text-sidebar-foreground transition-colors" data-testid="link-footer-coach">Homiquity Coach</Link></li>
