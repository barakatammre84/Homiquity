        ...
        <div className="grid gap-8 sm:grid-cols-2 md:grid-cols-4">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-1 text-sm text-white/70">
              ...
              <li><Link href="/partners" className="block rounded-md px-2 py-2 -mx-2 hover:text-white transition-colors" data-testid="link-footer-partners">Partner with us</Link></li>
